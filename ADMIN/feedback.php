...
<body>
    ...
    <div class="container mt-3"
        ...
        <button type="button" class="btn custom-btn" onclick="window.location.href='feedback_c.php'">
            Company Feedback
        </button>

        <!-- Job Seeker Feedback Title -->
        <h1 class="company-feedback-title">Job Seeker Feedbacks</h1>
    </div>
        ...
        <div style="max-height: 620px; overflow-y: auto;">
            <table class="table table-striped table-bordered" style="width: 100%; font-size: 19px; text-align: center;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM feedback ORDER BY id DESC"; // Fetch feedback in descending order
