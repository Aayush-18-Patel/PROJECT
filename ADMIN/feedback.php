...
<div class="container mt-3" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 50px;">
    <button type="button" class="btn btn-secondary" onclick="window.location.href='feedback_c.php'">Company Feedback</button>
    <h1 style="margin: 0; flex-grow: 1; text-align: center; color: #004D40;">Job Seeker Feedbacks</h1>
</div>
        ...
        <table class="table table-striped table-bordered" style="width: 100%; font-size: 19px; text-align: center;">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM feedback"; // Fetch all feedback records
