...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include('config.php');
    $action = $_POST['action'];
    $email = $_POST['company_email'] ?? '';  // Fix: Use null-coalescing to avoid undefined error
...
$_SESSION['company_password'] = $_POST['company_password'] ?? '';
$_SESSION['company_name'] = $_POST['company_name'] ?? '';
$_SESSION['company_industry'] = $_POST['company_industry'] ?? '';
...
<head>
    ...
    <script>
        function sendOTP(action = "generate") {
            ...
            formData.append("company_email", email); // FIXED: Use correct key
            ...
            fetch("", {
                ...
                .then(data => {
                    if (data.trim() === "success") {
                        ...
                        window.location.href = "../LOGIN-SIGNUP/company_registration.php";
                    } else {
                        document.getElementById("message").innerHTML = data;
                    }
                });
...
<body>
    ...
    <div class="container">
        ...
        <input type="email" id="email"
            value="<?php echo isset($_POST['company_email']) ? $_POST['company_email'] : ''; ?>" readonly>
